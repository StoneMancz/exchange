<template>
    <div class="main whites">
        ...
        <div class="legalAccount_msg flex between plr10 hide">
          <div>
              <p class="ft12 msg_title">{{$t('asset.canuse')}}</p>
        ...
        init(){
            ...
            headers: {'Authorization':  that.token}
                ...
                if(res.data.type  =='ok'){
                    ...
                    that.legal_balance = msg.change_balance;
                    that.lock_legal_balance = msg.lock_change_balance;
                    that.usdt_price = (msg.change_balance-0)*(msg.usdt_price);
                }else{
...
// WEBPACK FOOTER //
// src/view/accounts/dealAccount.vue