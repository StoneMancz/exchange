        ...
        <footer>
          <div class="content flex">
            ...
            <dl>
              ...
              <dd v-for="item in footFrist" @click="goDetail(item.id)" :key="item.id">{{item.title}}</dd>
            </dl>
            <dl>
              <dt>{{$t('foo.support')}}</dt>
              <dd v-for="item in footSecond" @click="goDetail(item.id)" :key="item.id">{{item.title}}</dd>
